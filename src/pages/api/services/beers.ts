...
import type { BeerData, NewBeerData, EditBeetData } from '../../../types/beers';
...
export const updateBeerData = (beerID: string | ObjectId, beerData: EditBeetData) => axios.patch(`/api/beers/${beerID}`, { ...beerData });
